...
const colorClasses = ["white", "black"];    
...
window.onscroll = function(){
    ...
    const scrollMultiple = Math.floor(currentScrollPos / window.innerHeight);
    const newColorIndex = scrollMultiple % colorClasses.length;
    ...
    if (newColorIndex !== currentColorIndex){
        ...
        const navLinks = navbar.getElementsByClassName("navLinks");
...
const sectionsToHide = document.querySelectorAll('section:not(.hero-section)');
